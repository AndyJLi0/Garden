...
const imageData = [
  { id: '1', uri: require("../../assets/watercan.png"), name: "Watering Can" },
  { id: '2', uri: require("../../assets/fertilizer.png"), name: "Fertilizer" },
  { id: '3', uri: require("../../assets/seed.png"), name: "Seed Bag" },
];
      ...
      <View style={styles.imageShelf}>
        {imageData.map((item) => (
          <TouchableOpacity key={item.id}>
            ...
            <Text style={{textAlign: "center", fontFamily: "JosefinSans_400Regular",
            fontSize: header2size,
            color: textPrimary,}}>{item.name}</Text>
          </TouchableOpacity>
        ))}
      </View>
    </View>
